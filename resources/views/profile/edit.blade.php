...
@section('title', 'Edit Profile | ProGymHub')
@section('content')
<style>
    body {
    ...
    /* Import FontAwesome if not already available */
    ...
    /* Enhanced select appearance when open */
    .form-select:focus {
...
<div class="container profile-edit-container">
    ...
    <!-- Status message area that will be dynamically updated -->
    ...
    <form method="POST" action="{{ route('profile.update') }}" id="profileForm">
        @csrf
        @method('PUT')
        <!-- Hidden debug field to help track submissions -->
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="custom-select-wrapper">
                                ...
                                <i class="fas fa-venus-mars custom-select-icon"></i>
                            </div>
                            @error('gender')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
            ...
            <div class="col-md-6">
                ...
                <!-- Fitness Information -->
                <div class="card mb-4">
                    <div class="card-header">Fitness Information</div>
                    <div class="card-body">                        <div class="mb-3">
                            ...
                            <div class="custom-select-wrapper">
                                ...
                                <i class="fas fa-bullseye custom-select-icon"></i>
                            </div>
                            @error('goal')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                            ...
                            <div class="custom-select-wrapper">
                                ...
                                <i class="fas fa-chart-line custom-select-icon"></i>
                            </div>
                            @error('fitness_level')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <div class="custom-select-wrapper">
                                ...
                                <i class="fas fa-clock custom-select-icon"></i>
                            </div>
                            ...
                            <div class="custom-select-wrapper">
                                ...
                                <i class="fas fa-stopwatch custom-select-icon"></i>
                            </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">                        <div class="mb-3">
                            ...
                            <div class="custom-select-wrapper">
                                ...
                                <i class="fas fa-utensils custom-select-icon"></i>
                            </div>
        ...
        function calculateBMI() {
            if (heightInput?.value && weightInput?.value) {
                ...
                if (heightInMeters > 0 && weightKg > 0) {
                    ...
                    // Display the BMI below the inputs
