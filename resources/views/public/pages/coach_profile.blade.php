...
<main>
    ...
    <div class="container profile-container">
        <!-- Back to Club Link -->
        @if($coach->club)
        <a href="{{ route('club_details', $coach->club->encoded_id) }}" class="back-to-club">
            <i class="fas fa-arrow-left"></i> Back to {{ $coach->club->name }}
        </a>
        @endif
        ...
        <!-- <div class="profile-section">
            ...
            <div class="text-center mt-4">
                @if($coach->club)
                <a href="{{ route('club_details', $coach->club->encoded_id) }}" class="contact-btn">
                    <i class="fas fa-dumbbell me-2"></i> Visit {{ $coach->club->name }}
                </a>
                @endif
            </div>
        </div> -->
