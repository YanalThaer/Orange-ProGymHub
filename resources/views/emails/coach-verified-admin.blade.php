...
<head>
    <title>New Coach Verified</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h2>New Coach Verified</h2>
        </div>

        <p>Hello {{ $admin->name }},</p>

        <p>A new coach from <strong>{{ $coach->club->name }}</strong> has successfully verified their email address.</p>
