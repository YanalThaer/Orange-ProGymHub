...
<html>
<head>
    <title>Coach Account Restored - Admin Notification</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>This is to notify you that a previously deleted coach account has been restored in the ProGymHub platform by {{ $club->name }}.</p>
