...
<html>
<head>
    <title>Coach Account Action</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        ...
        @if($action == 'deleted')
        <p>We regret to inform you that your ProGymHub coach account has been <strong>deleted</strong> by an administrator.</p>
        
        <p>If you believe this was done in error, please contact your club administrator or our support team.</p>
        @else
        <p>Great news! Your ProGymHub coach account has been <strong>restored</strong>.</p>
        ...
        <ul>
            ...
            <li>Club: {{ $coach->club ? $coach->club->name : 'Not Assigned' }}</li>
        </ul>
