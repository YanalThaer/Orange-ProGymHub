...
<div class="error-container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="error-code">{{ isset($errorCode) ? $errorCode : '500' }}</div>
            <h2 class="error-message">{{ isset($message) ? $message : 'Oops! Something went wrong' }}</h2>
            <p class="error-description">
                {{ isset($description) ? $description : 'We apologize for the inconvenience. Please try again later or contact support if the problem persists.' }}
            </p>
