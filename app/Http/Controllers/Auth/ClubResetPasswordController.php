...
use App\Http\Controllers\Auth\ClubPasswordNotificationController;
use Illuminate\Support\Facades\Hash;
use Illuminate\Auth\Events\PasswordReset;
use Illuminate\Support\Str;

class ClubResetPasswordController extends Controller
{
    use ResetsPasswords;
     ...
     * @var string
     */
    protected $redirectTo = '/dashboard/club';
    ...
    {
        return view('auth.club.reset')->with(
